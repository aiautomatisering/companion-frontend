...
export const Header = () => {
  ...
  return (
    <header className=" fixed top-0 left-0 right-0  mx-auto h-16 flex justify-between items-center px-6 py-4 shadow-md bg-gray-50 z-50">
      <div className="flex w-full mx-auto px-7 justify-between items-center max-w-6xl">
